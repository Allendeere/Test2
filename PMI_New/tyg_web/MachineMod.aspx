<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MachineMod.aspx.cs" Inherits="MachineList" %>
<!DOCTYPE html>
...
<script type="text/javascript">
	...
	function modMachine(){
		...
		if(machineID != "" && coordinateX != "" && coordinateY != ""){
			machine.modMachine(factoryID, areaID, platformID, machineID, slaveNo, channel, coordinateX, coordinateY, founder);
		}else{
			alert("請填入所有必填欄位!!!");
		}
	}
					...
					<div class="container view_content">
						<form id="area-add" name="area-add" method="post" action="###">
							...
							<div class="row ma_btm_20">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" id="machineID" name="machineID" readonly="readonly" />
									<span>禁止修改</span>
								</div>
							</div>
							<div class="row ma_btm_20">
							...
							<div class="row ma_btm_20">
								<div class="row ">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 ma_btm_20"><input type="button" value="儲存" onClick="modMachine()" class="btn input_style1"></div>
								</div>
							</div>
							<div class="clr"></div>
						</form>
