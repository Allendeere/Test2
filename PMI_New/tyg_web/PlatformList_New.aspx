<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformList_New.aspx.cs" Inherits="PlatformList_New" %>
<!DOCTYPE html>
		...
		<div class="container">
			<div class="v1">
				<div class="ma_0_10">
					...
					<div class="table_ctrl">
						<div class="flo_l">
							<% if (PlatformAuth == 2){ %><button type="button" class="btn btn-default" onclick="platform.gotoAdd()">新增平台資料(新廠)</button><% } %>
						</div>
					</div>
					<!--表格-->
