<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaMod.aspx.cs" Inherits="AreaList" %>
<!DOCTYPE html>
...
<script type="text/javascript">
    function soap(){
        ...
        area.getArea("<% Response.Write(Request.QueryString["id"]); %>");
	};
	...
	function modArea(){
		...
		if(areaID != "" && areaName != "" && areaIP != "" && areaPort != ""){
			area.modArea(factoryID, areaID, areaName, areaIP, areaPort, testMode, note, updater);
		}else{
			alert("請填入所有必填欄位!!!");
		}
	}
...
<body onload="soap()">
	...
	<div id="content">
		<div class="container">
			<div class="v1">
				<div class="ma_0_10">
					<h1 class="clearfix ma_10_0"><span class="fn_20 flo_l fn_black fn_bold">區域成型機修改</span></h1>
					<div class="hr bc_blue3 ma_btm_20"></div>
					<div class="container view_content">
						<form id="area-edit" name="area-edit" method="post" action="###">
							...
							<div class="row ma_btm_20">
								...
								<div class="row ">
									...
									<div class="col-md-6 col-sm-6 col-xs-12 ma_btm_20"><input type="button" value="儲存" onClick="modArea()" class="btn input_style1"></div>
								</div>
							</div>
							<div class="clr"></div>
						</form>
