<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformPile_New.aspx.cs" Inherits="PlatformList" %>
<!DOCTYPE html>
...
<script type="text/javascript">
    function soap() {
        ...
        pile.getListByPlatformID("<% Response.Write(Request.QueryString["pid"]); %>");
    };
</script>
</head>
<body onload="soap()">
	...
	<div id="content">
		<div class="container">
			<div class="v1">
				<div class="ma_0_10">
					<h1 class="clearfix ma_10_0"><span class="fn_20 flo_l fn_black fn_bold">供料台料堆</span>
                        <a href="javascript:location.href='PileHeap.aspx'" class="btn btn-default btn-lg flo_r">回上一頁</a>
                        <!--<button type="button" class="btn btn-default" onclick="location.href='PileHeap.aspx'">返回供料台列表</button>-->
					</h1>
