<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformMod_New - 複製.aspx.cs" Inherits="PlatformList" %>
<!DOCTYPE html>
...
<script type="text/javascript">	
	...
	function modPlatform(){		
		...
		if (platformID != "" && platformName != "" && platformIP != "" && platformPort != "" && groupNo != "" && xNum != "" && yNum != "") {
			platform.modPlatform(factoryID, areaID, platformID, platformName, platformIP, platformPort, groupNo,xNum, yNum, note, updater);
			//if(oldMNum > mNum){
