<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformSet_New.aspx.cs" Inherits="PlatformSet" %>
<!DOCTYPE html>
...
<script type="text/javascript">	
	function soap(){
        ...
        pile.getMPileList("<% Response.Write(Request.QueryString["pid"]); %>", "<% Response.Write(Request.QueryString["gid"]); %>", "<% Response.Write(Request.QueryString["hid"]); %>", true);
	};
