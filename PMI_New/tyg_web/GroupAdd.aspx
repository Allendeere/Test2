<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupAdd.aspx.cs" Inherits="GroupAdd" %>
<!DOCTYPE html>
...
<script>    
    ...
    function addGroups() {
        ...
        if (groupName != "") {
            group.addGroups(groupName, detailAuth, infoAuth, allowAuth, newsAuth, historyAuth, statusAuth, factoryAuth, areaAuth, platformAuth, groupAuth, founder);
        } else {
            alert("請填入所有必填欄位!!!");
        }
    }
							...
							<div class="container wid100">
								<div class="row ma_btm_20">
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
										<p><input type="text" id="groupName" name="groupName" class="wid100"></p>
									</div>
								</div>
								<div class="row ">
									<div class="col-md-3 col-sm-3 col-xs-12">
									...
									<div class="pa_0_15">
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="detailAuth" name="detailAuth" value="0" checked="checked">不可使用</label>
										...
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="infoAuth" name="infoAuth" value="0" onchange="showAllow(false)" checked="checked">不可使用</label>
										...
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="newsAuth" name="newsAuth" value="0" checked="checked">不可使用</label>
								...
								<div class="row">
									<div class="pa_0_15">
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="factoryAuth" name="factoryAuth" value="0" checked="checked">不可使用</label>
										...
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="areaAuth" name="areaAuth" value="0" checked="checked">不可使用</label>
										...
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="platformAuth" name="platformAuth" value="0" checked="checked">不可使用</label>
										...
										<div class="row ma_btm_20">
											...
											<div class="col-sm-9 col-xs-12">
												<p class="radio-group">
													<label class="radio-inline"><input type="radio" id="groupAuth" name="groupAuth" value="0" checked="checked">不可使用</label>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-xs-12 ma_btm_20">
										<input type="submit" value="儲存" onClick="addGroups()" class="btn input_style1">
									</div>
								</div>
							</div>
						</div>						
