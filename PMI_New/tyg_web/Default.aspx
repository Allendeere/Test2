            ...
            <div class="v1">
                <div class="ma_0_10">
                    ...
                    <ul class="nav nav-tabs" role="tablist" id="myTab">
                        ...
                        <% } %>
                        <% if (FactoryAuth != 0 || AreaAuth != 0 || PlatformAuth != 0 || GroupAuth != 0 || ByPassAuth != 0)
                            { %>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="member_set">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="StatusDetail.aspx">
                                    <img class="wid100" src="image/mbtn.png" alt="" /></a>
                            </div>
                            <% } %>
                            <% if (InfoAuth != 0)
                            { %>
                            <!--供料台-->
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="PlatformState.aspx">
                                    <img class="wid100" src="image/cbtn.png" alt="" /></a>
                            </div>
                            <% } %>
                            <% if (InfoAuth != 0)
                            { %>
                            <!--新式供料台-->
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="PlatformState_New.aspx">
                                    <img class="wid100" src="image/newcbtn.png" alt="" /></a>
                            </div>
                            <% } %>
                            <% if (NewsAuth != 0)
                            { %>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="News.aspx">
                                    <img class="wid100" src="image/ibtn.png" alt="" /></a>
                            </div>
                            <% } %>
                        </div>
                        <% } %>
                        ...
                        <div role="tabpanel" class="tab-pane" id="history_set">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="History.aspx">
                                    <img class="wid100" src="image/sbtn.png" alt="" /></a>
                            </div>
                            <% } %>
                            <% if (StatusAuth != 0)
                            { %>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="Status.aspx">
                                    <img class="wid100" src="image/statistic-btn.png" alt="" /></a>
                            </div>
                            <% } %>
                        </div>
                        <% } %>
                        <% if (FactoryAuth != 0 || AreaAuth != 0 || PlatformAuth != 0 || GroupAuth != 0 || ByPassAuth != 0 || WeightAuth != 0 || RIOAuth != 0)
                            { %>
                        <div role="tabpanel" class="tab-pane" id="authority_set">
                            <div class="row">
                                ...
                                <!--廠區管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="FactoryList.aspx">
                                        <img class="wid100" src="image/fabtn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <% if (AreaAuth != 0)
                                { %>
                                <!--區域成型機管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="AreaList.aspx">
                                        <img class="wid100" src="image/area-btn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <% if (PlatformAuth != 0)
                                { %>
                                <!--供料台管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="PlatformList.aspx">
                                        <img class="wid100" src="image/fbtn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <% if (PlatformAuth != 0)
                                { %>
                                ...
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="GroupList.aspx">
                                        <img class="wid100" src="image/abtn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <%if (ByPassAuth != 0)
                                {%>
                                ...
                                <!--PASS接頭管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="ByPassSetting.aspx">
                                        <img class="wid100" src="image/pbtn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <%if (WeightAuth != 0)
                                {%>
                                <!--秤重網頁設訂管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="WeightSetting.aspx">
                                        <img class="wid100" src="image/wsbtn.png" alt="" /></a>
                                </div>
                                <% } %>
                                <%if (RIOAuth != 0)
                                {%>
                                <!--RemoteIO管理-->
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a href="RIOSetting.aspx">
                                        <img class="wid100" src="image/riobtn.png" alt="" /></a>
                                </div>
                                <% } %>
                            </div>
