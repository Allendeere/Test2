<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformAdd_New.aspx.cs" Inherits="PlatformList_New" %>
<!DOCTYPE html>
...
<script type="text/javascript">
	...
	function addPlatform(){
		...
		if (platformID != "" && platformName != "" && platformIP != "" && platformPort != "") {
            platform.addPlatform(factoryID, areaID, platformID, platformName, platformIP, platformPort, groupNo, xNum, yNum, note, founder, area2ID);
			for(i=1;i<=xNum;i++){
				var MPileSort = i;
			...
			<div class="v1">
				<div class="ma_0_10">
					...
					<div class="container view_content">
						...
						<div class="row ma_btm_20">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<p class="title_lvl1"><span class="fn_red">*</span>X軸料堆數量</p>
							</div>
							<div class="col-md-9 col-sm-9 col-xs-12">
						...
						<div class="row ma_btm_20">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<p class="title_lvl1"><span class="fn_red">*</span>Y軸料堆數量</p>
							</div>
							<div class="col-md-9 col-sm-9 col-xs-12">
