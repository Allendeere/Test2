<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PileHeap_New.aspx.cs" Inherits="PileHeap_New" %>
<!DOCTYPE html>
			...
			<div class="v1">
				<div class="ma_0_10">
					<h1 class="clearfix ma_10_0"><span class="fn_20 flo_l fn_black fn_bold">供料台</span>
                         <a href="javascript:location.href='PlatformState_New.aspx'" class="btn btn-default btn-lg flo_r">回上一頁</a>
