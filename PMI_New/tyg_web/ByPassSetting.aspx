<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ByPassSetting.aspx.cs" Inherits="Default3" %>
<!DOCTYPE html>
...
<script type="text/javascript">
	function soap(){
        ...
        machine.getByPass("<% Response.Write(Request.Form["factoryID"]); %>", "<% Response.Write(Request.Form["areaID"]); %>", "<% Response.Write(Session["user"]); %>");
    };
</script>
</head>
<body onload="soap()">
	...
	<!--content-->
	<div id="content">
        <div id="loading" style="display:none"><img src="image/ajax-loader.gif" /></div>
		<div class="container">
			<div class="v1">
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
                        <input class="btn btn-primary btn-lg btn-block" type="button"  id ="btnRefresh" onclick ="machine.refreshByPass()" value="重新整理"/>      
					</div>
							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
									<div class="panel-body">
										<form id="search-form" method="post" action="ByPassSetting.aspx">
