<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FactoryList.aspx.cs" Inherits="FactoryList" %>
<!DOCTYPE html>
...
<body onload="soap()">
	...
	<div id="content">
		<div class="container">
			<div class="v1">
				<div class="ma_0_10">
					<h1 class="clearfix ma_10_0"><span class="fn_20 flo_l fn_black fn_bold">廠區管理</span></h1>
					<div class="hr bc_blue3 ma_btm_20"></div>
					<div class="table_ctrl">
						<div class="flo_l">
							<% if (FactoryAuth == 2){ %><button type="button" class="btn btn-default" onclick="factory.gotoAdd()">新增廠區</button><% } %>
						</div>
					</div>
					<!--表格-->
