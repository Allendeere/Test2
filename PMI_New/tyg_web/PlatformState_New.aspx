<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformState_New.aspx.cs" Inherits="PlatformState_New" %>
<!DOCTYPE html>
...
<script type="text/javascript">
	function soap(){
        ...
        platform.getPlatformState_New("<% Response.Write(Request.Form["factoryID"]); %>", "<% Response.Write(Request.Form["areaID"]); %>");
	};
</script>
</head>
<body onload="soap()">
			...
			<div class="v1">
				...
				<div class="row m-tb1">
					<div class="col-sm-3 col-xs-12">
                        <% if (InfoAuth == 2){ %><a href="PileSet_New.aspx" class="btn btn-default btn-lg">更換料種</a><% } %>
                        <% if (InfoAuth == 2){ %><a href="PileHeap_New.aspx" class="btn btn-default btn-lg">設定料堆</a><% } %>
					</div>
					...
					<!--更換料種按鈕(新廠)-->
					<div class="col-sm-3 col-xs-12">
						<% if (InfoAuth == 2){ %><a href="PileSet_New.aspx" class="btn btn-default btn-lg">更換料種(新廠)</a><% } %>
                        <% if (InfoAuth == 2){ %><a href="PileHeap_New.aspx" class="btn btn-default btn-lg">設定料堆(新廠)</a><% } %>
					</div>
