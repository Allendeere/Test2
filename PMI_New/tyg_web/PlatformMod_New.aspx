<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlatformMod_New.aspx.cs" Inherits="PlatformList" %>
<!DOCTYPE html>
...
<script type="text/javascript">	
	...
	function modPlatform(){		
		...
		if (platformID != "" && platformName != "" && platformIP != "" && platformPort != "" && groupNo != "" && xNum != "" && yNum != "") {
            platform.modPlatform(factoryID, areaID, platformID, platformName, platformIP, platformPort, groupNo, xNum, yNum, note, updater, area2ID);
			//if(oldMNum > mNum){
					...
					<div class="container view_content">
						<div class="row ma_btm_20">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								...
								<select id="area2ID" name="area2ID"></select>
						...
						<div class="row ma_btm_20">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<p class="title_lvl1"><span class="fn_red">*</span>群組編號</p>
							</div>
							<div class="col-md-9 col-sm-9 col-xs-12">
						...
						<div class="row ma_btm_20">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<p class="title_lvl1"><span class="fn_red">*</span>X軸孔洞數量</p>
							</div>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" id="xNum" name="xNum" />
								必填，限定數字
							</div>
						</div>
						<div class="row ma_btm_20">
							<div class="col-md-3 col-sm-3 col-xs-12">
								<p class="title_lvl1"><span class="fn_red">*</span>Y軸孔洞數量</p>
							</div>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" id="yNum" name="yNum" />
								必填，限定數字
							</div>
						</div>
						<div class="row ma_btm_20">
