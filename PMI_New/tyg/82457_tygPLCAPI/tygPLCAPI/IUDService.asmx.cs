...
namespace tygPLCAPI
{
    ...
    public class IUDService : System.Web.Services.WebService
    {
        ...
        private string RIOJson(DataTable dt)
        {
            //Json Data array
            JArray jsonarr = new JArray();
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    int RIOID = dr.Field<Int32>("RIO_ID");
                    string RIOPlatformID = dr.Field<String>("RIO_PlatformID");
                    string RIOIP = dr.Field<String>("RIO_IP").Trim();
                    string RIOMachineID = dr.Field<String>("RIO_MachineID").Trim();

                    //Json Data
                    JObject jsonObject =
                        new JObject(
                            new JProperty("RIOID", RIOID),
                            new JProperty("RIOPlatformID", RIOPlatformID),
                            new JProperty("RIOIP", RIOIP),
                            new JProperty("RIOMachineID", RIOMachineID)
                        );
                    jsonarr.Add(jsonObject);
                }
            }
        ...
        private string ALLJson(DataTable dt)
        {
            //Json Data array
            JArray jsonarr = new JArray();
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    int RIOID = dr.Field<Int32>("RIO_ID");
                    string PlatformID = dr.Field<String>("pn_PlatformID");
                    string PlatformName = dr.Field<String>("pn_PlatformName");
                    string FactoryID = dr.Field<String>("pn_FactoryID");
                    string FactoryName = dr.Field<String>("FactoryName");
                    string RIOIP = dr.Field<String>("RIO_IP").Trim();
                    string RIOMachineID = dr.Field<String>("RIO_MachineID").Trim();
        ...
        {
            string getPlatforms = string.Format("select * from Platform_New left join area as a on a.AreaID = Platform_New.pn_AreaID order by pn_PlatformID");
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatforms);
        ...
        {
            string getPlatforms = string.Format("select * from RemoteIO order by RIO_PlatformID");
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatforms);
        ...
        {
            string getAll = string.Format("SELECT b.pn_FactoryID,c.FactoryName,b.pn_PlatformName, b.pn_PlatformID, a.RIO_ID, a.RIO_IP, a.RIO_MachineID FROM RemoteIO AS a  LEFT JOIN Platform_New AS b ON a.RIO_PlatformID= b.pn_PlatformID LEFT JOIN Factory AS c ON b.pn_FactoryID= c.FactoryID ORDER BY c.FactoryID, b.pn_PlatformID;");

            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getAll);
        ...
        public string GetThePlatform_New(string factoryID, string areaID)
        {
            ...
            if (factoryID != "")
                where += string.Format(" and pn_FactoryID = '{0}'", factoryID);
            if (areaID != "")
                where += string.Format(" and c.AreaID = '{0}'", areaID);
            string getPlatforms = string.Format("select * from Platform_New as a left join PlatformDetail as b on b.PlatformID = a.pn_PlatformNo left join Area as c on c.AreaNo = b.AreaID where 1=1{0} order by pn_PlatformID", where);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatforms);
        ...
        {
            string getPlatform = string.Format("select b.pn_PlatformNo , b.pn_CreateDate,b.pn_AlterDate,b.pn_FactoryID,b.pn_PlatformID,b.pn_PlatformName,b.pn_PlatformIP,b.pn_PlatformPort,b.pn_GroupNo,b.pn_XNum,b.pn_YNum,b.pn_Note,b.pn_ConnectionStatus,b.pn_VoltageState,b.pn_ConnectedTime,b.pn_DisconnectedTime,b.pn_DisconnectedTime,b.pn_Founder,b.pn_Updater,c.AreaID as pn_AreaID \r\nfrom PlatformDetail as a \r\nleft join Platform_New as b on a.PlatformID = b.pn_PlatformNo \r\nleft join Area as c on a.AreaID = c.AreaNo \r\nwhere b.pn_PlatformID='{0}'", platformID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatform);

            return PlatformJson_New(dt);
        }
        [WebMethod]
        public string GetRIOByID(string rioID)
        {
            string getPlatform = string.Format("select * from RemoteIO where RIO_ID = '{0}'", rioID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatform);
        ...
        public string GetPlatformByAreaID(string areaID)
        {
            ...
            string getPlatforms = string.Format("select a.pn_PlatformNo,a.pn_CreateDate,a.pn_AlterDate,a.pn_FactoryID,a.pn_PlatformID,a.pn_PlatformName,a.pn_PlatformIP,a.pn_PlatformPort,a.pn_GroupNo,a.pn_XNum,a.pn_YNum,a.pn_Note,a.pn_ConnectionStatus,a.pn_VoltageState,a.pn_ConnectedTime,a.pn_DisconnectedTime,a.pn_Founder,a.pn_Updater,b.AreaID as pn_AreaID from PlatformDetail as p left join Platform_New as a on a.pn_PlatformNo = p.PlatformID left join Area as b on b.AreaNo = p.AreaID where b.AreaID = '{0}' order by p.PlatformID", areaID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatforms);
        ...
        public string GetPlatformOption_New(string factoryID, string areaID)
        {
            string where = "";
            if (factoryID != "")
                where += string.Format(" and a.pn_FactoryID = '{0}'", factoryID);
            if (areaID != "")
                where += string.Format(" and b.AreaID = '{0}'", areaID);
            string getPlatforms = string.Format("select a.pn_PlatformNo,a.pn_CreateDate,a.pn_AlterDate,a.pn_FactoryID,a.pn_PlatformID,a.pn_PlatformName,a.pn_PlatformIP,a.pn_PlatformPort,a.pn_GroupNo,a.pn_XNum,a.pn_YNum,a.pn_Note,a.pn_ConnectionStatus,a.pn_VoltageState,a.pn_ConnectedTime,a.pn_DisconnectedTime,a.pn_Founder,a.pn_Updater,b.AreaID as pn_AreaID from PlatformDetail as p left join Platform_New as a on a.pn_PlatformNo = p.PlatformID left join Area as b on b.AreaNo = p.AreaID where 1 = 1{0} order by p.PlatformID", where);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatforms);
        ...
        //            string getPlatform2 = string.Format("select a.pn_PlatformNo ,b.AreaNo from Platform_New as a left join Area as b on a.pn_AreaID = b.AreaID where pn_PlatformID = '{0}'", platformID);
        //            DataTable dt2 = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatform2);
        ...
        //                platformID2 = dr2.Field<int>("pn_PlatformNo");
        //                areaid2 = dr2.Field<byte>("AreaNo");
        //            }
        //            if (areaid2 > 0)
        //            {
        //                string insertPlatform2 = string.Format("insert into PlatformDetail (AreaID,PlatformID) values ('{0}','{1}')", areaid2, platformID2);
        //                SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, insertPlatform2);
        //            }
        ...
        [WebMethod]
        public string AddPlatform_New(string factoryID, string areaID, string platformID, string platformName, string platformIP, int platformPort, int groupNo, int xNum, int yNum, string note, string founder, string area2ID)
        {
            string rslt = "";
            ...
            else
            {
                try
                {
                    ...
                    DataTable dt2 = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, string.Format("select a.pn_PlatformNo from Platform_New as a where pn_PlatformID = '{0}'", platformID));
                    int platformID2 = 0;
                    foreach (DataRow dr2 in dt2.Rows)
                    {
                        if (dr2.Field<int>("pn_PlatformNo") > 0) platformID2 = dr2.Field<int>("pn_PlatformNo");
                    }
                    DataTable dtarea = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, string.Format("select * from Area as b where AreaID = '{0}' or AreaID='{1}'", areaID, area2ID));

                    foreach (DataRow drarea in dtarea.Rows)
                    {
                        if (drarea.Field<byte>("AreaNo") > 0)
                        {
                            string insertPlatform2 = string.Format("insert into PlatformDetail (AreaID,PlatformID) values ('{0}','{1}')", drarea.Field<byte>("AreaNo"), platformID2);
                            SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, insertPlatform2);
                        }
                    }
        ...
        [WebMethod]
        public string AddRIO(string platformID, int rioID, string rioIP, string machineID)
        {
            string rslt = "";

            string getRIO = string.Format("select count(*) as count from RemoteIO where RIO_ID = '{0}' and RIO_PlatformID='{1}'", rioID, platformID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getRIO);
            ...
            else
            {
                ...
                {
                    //Insert
                    string insertPlatform = string.Format("insert into RemoteIO (RIO_ID,RIO_IP,RIO_MachineID,RIO_PlatformID) values ('{0}','{1}','{2}','{3}')",
                                                                                rioID, rioIP, machineID, platformID);
                    SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, insertPlatform);
        ...
        [WebMethod]
        public string ModPlatform_New(string factoryID, string areaID, string platformID, string platformName, string platformIP, int platformPort, int groupNo, int xNum, int yNum, string note, string updater, string area2ID)
        {
            string rslt = "";
        ...
        [WebMethod]
        public string ModRIO(int rioID, string rioIP, string machineID, string platformID)
        {
            string rslt = "";

            string getPlatform = string.Format("select count(*) as count from RemoteIO where RIO_ID = '{0}'", rioID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getPlatform);
            ...
            try
            {
                ...
                //string modPlatform = string.Format("update Platform_New set pn_AlterDate = '{0}', pn_FactoryID = '{1}', pn_AreaID = '{2}', pn_PlatformName = '{3}', pn_PlatformIP = '{4}', pn_PlatformPort = '{5}', pn_GroupNo = '{6}',pn_XNum = '{7}', pn_YNum = '{8}', pn_Note = '{9}', pn_Updater = '{10}' where pn_PlatformID = '{11}'",
                //                                                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), factoryID, areaID, platformName, platformIP, platformPort, groupNo, xNum, yNum, note, updater, platformID);
                string modPlatform = string.Format("update RemoteIO set  RIO_IP = '{0}', RIO_MachineID = '{1}', RIO_PlatformID = '{3}' where RIO_ID = '{2}'",
                                                                      rioIP, machineID, rioID, platformID);
                SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, modPlatform);
        ...
        public string DelPlatform(string platformID)
        {
            ...
            try
            {
                string s1 = string.Format("select a.* from PlatformDetail as a left join Platform_New as b on b.pn_PlatformNo = a.PlatformID where b.pn_PlatformID = '{0}'", platformID);
                DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, s1);


                foreach (DataRow ro in dt.Rows)
                {
                    SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, string.Format("delete from PlatformDetail where PlatformID = '{0}'", ro.Field<int>("PlatformID")));
                }



                string delPlatform = string.Format("delete from Platform_new where pn_PlatformID = '{0}'", platformID);
                SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, delPlatform);
        ...
        [WebMethod]
        public string DelRIO(string rioID)
        {
            string rslt = "";
            ...
            try
            {
                string delPlatform = string.Format("delete from RemoteIO where RIO_ID = '{0}'", rioID);
                SqlHelper.ExecuteNonQuery(SqlHelper.MSSQLConnection, CommandType.Text, delPlatform);
        ...
        private string MachineJson(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    string MachineNo = dr.Field<String>("MachineNo");
                    string CreateDate = dr.Field<DateTime>("CreateDate").ToString("yyyy/MM/dd HH:mm:ss");
                    string AlterDate = dr.Field<DateTime>("AlterDate").ToString("yyyy/MM/dd HH:mm:ss");
                    string FactoryID = dr.Field<String>("FactoryID").Trim();
        ...
        [WebMethod]
        public string GetTheMachine_new(string factoryID, string areaID)
        {
            string where = "";
            if (factoryID != "")
                where += string.Format(" and m.FactoryID = '{0}'", factoryID);
            if (areaID != "")
                where += string.Format(" and m.AreaID = '{0}'", areaID);
            string getMachines = string.Format("select m.*,f.FactoryName,a.AreaName  from Machine as m left join Platform_New as pn on m.PlatformID = pn.pn_PlatformID left join PlatformDetail as pd on pn.pn_PlatformNo = pd.PlatformID left join Area as a on pd.AreaID = a.AreaNo left join Factory as f on m.FactoryID=f.FactoryID where 1 = 1{0} Order by m.FactoryID, a.AreaID desc, m.SlaveNo ", where);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getMachines);
        ...
        [WebMethod]
        public string GetMachineByRioID(string rioID)
        {
            string getMachines = string.Format("SELECT c.*,e.AreaName,d.FactoryName,b.pn_PlatformName FROM RemoteIO AS a LEFT JOIN Platform_New AS b ON a.RIO_PlatformID= b.pn_PlatformID LEFT JOIN Machine AS c ON a.RIO_MachineID= c.MachineID LEFT JOIN Factory AS d ON b.pn_FactoryID= d.FactoryID LEFT JOIN Area AS e ON c.AreaID= e.AreaID where a.RIO_ID = '{0}' Order by c.FactoryID, c.PlatformID desc, c.SlaveNo", rioID);
            DataTable dt = SqlHelper.ExecuteDataTable(SqlHelper.MSSQLConnection, CommandType.Text, getMachines);
