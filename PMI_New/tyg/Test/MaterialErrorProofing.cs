...
namespace MaterialErrorProofing
{
    public partial class FormDetection : Form
    {
        ...
        private void Daq_Platform_HoleChanged(object Sender, HoleChangedArgument_new e)
        {
            ...
            string sth=null;//newee
            platform.Parent_new.ForEach(x => sth += x.ID + " & ");

            //strMessage = "Hole Changed (" + platform.Parent_new.FirstOrDefault().Parent.ID + "." + sth + "." + platform.ID + ") [";
            ...
            strMessage = "Hole Changed (" + mhole.Parent.Parent_new.FirstOrDefault().Parent.ID + "." + sth + "." + mhole.Parent.ID + "." + mhole.ID + ") [";
            //for (int index = 0; index < holeIDs.Length; index++)
            //{
            //    strMessage += holeIDs[index];
            //    if (index < holeIDs.Length - 1)
        ...
        private void Daq_MHole_HoleChanged(object Sender, HoleChangedArgument_new e)
        {
            ...
            string sth = null;//newee
            mhole.Parent.Parent_new.ForEach(x => sth += x.ID + " & ");
        ...
        private void Daq_ConnectChanged(object Sender, ModbusConnectChangedArgument e)
        {
            ...
            else if (e.ModbusType == DeviceType.Platform)
            {
                ...
                strMessage = "Connect Changed (" + e.IsConnected.ToString() + ") (" + platform.Parent_new.FirstOrDefault().Parent.ID + "." + sth + "." + platform.ID + ")";
                if ((this.dgvPlatform.Visible) && (this.Contains(this.dsView.Platform, platform.ID, ref row)))
                {
                    bool b=false;
                    platform.Parent_new.ForEach(x => { 
                        if(x.Equals(this.dgvPlatform.Tag))
                        b= true;
                        });
            ...
            else if (e.ModbusType == DeviceType.MHole)
            {
                ...
                strMessage = "Connect Changed (" + e.IsConnected.ToString() + ") (" + mhole.Parent.Parent_new.FirstOrDefault().Parent.ID + "." + sth + "." +mhole.Parent.ID + "." + mhole.ID + "." + mhole.IPAddress + ")";
