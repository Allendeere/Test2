...
namespace TYG.HoleDetect
{
    ...
    public class DAQ : IDisposable
    {
        ...
        /// </summary>
        public event HoleChangedEventHandler_new Platform_HoleChanged;

        /// <summary>
        /// MHole Hole Changed Event
        /// </summary>
        public event HoleChangedEventHandler_new MHole_HoleChanged;
                ...
                foreach (Area area in factory.Areas.Values)
                {
                    ...
                    foreach (Platform platform in area.PlatForms.Values)
                    {
                        ...
                        foreach(MHole mhole in platform.MHoles.Values)
                        {
                            ...
                            mhole.HoleChanged_new += MHole_HoleChanged_EventHandler;
                        }
                    }
        ...
        /// <param name="Sender">Sender</param>
        /// <param name="e">Event Argument</param>
        private void Platform_HoleChanged_EventHandler(object Sender, HoleChangedArgument_new e)
        {
        ...
        /// <param name="Sender">Sender</param>
        /// <param name="e">Event Argument</param>
        private void MHole_HoleChanged_EventHandler(object Sender, HoleChangedArgument_new e)
        {
