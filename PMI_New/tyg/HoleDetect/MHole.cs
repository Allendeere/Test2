...
namespace TYG.HoleDetect
{
    public class MHole : IDisposable
    {
        ...
        /// <summary>
        /// Hole Changed Event new
        /// </summary>
        internal event HoleChangedEventHandler_new HoleChanged_new;//newee
        ...
        internal void SetHoleStatus(ref bool[] paramHoleStatus)
        {
            ...
            if (isChanged)
            {
                ...
                this.Parent.Parent_new.ForEach(x => areaslist.Add(x.ID));//存入AreaID陣列
                List<string> platformslist = new List<string>();
                platformslist.Add(this.Parent.ID);
                HoleChangedArgument_new e_new = new HoleChangedArgument_new(areaslist, platformslist, this.ID, this.MachineID);
                e_new.HoleStatus = this.GetHoleStatus();
                this.RefreshTime = DateTime.Now;
        ...
        /// </summary>
        /// <param name="e">Event Argument</param>
        protected void OnHoleChanged_new(HoleChangedArgument_new e)//newee
        {
            if (this.HoleChanged_new != null)
                this.HoleChanged_new(this, e);
        }
