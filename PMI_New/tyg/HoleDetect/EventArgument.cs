...
namespace TYG.HoleDetect
{
    ...
    public class HoleChangedArgument_new : System.EventArgs //改變 HoleChangedArgument strAreaID、strFactoryID的類型
    {
        private string  strPlatFormID, strMHoleID, strMachineID;
        private List<string> strAreaID,strFactoryID = new List<string>();
        private string[] holeDetection = null;
        private bool[] holeStatus = null;
        /// <summary>
        /// Constructor
        ...
        /// <param name="paramAreaID">Area ID</param>
        /// <param name="paramPlatFormID">PlatForm ID</param>
        internal HoleChangedArgument_new(List<string> paramFactoryID, List<string> paramAreaID, string paramPlatFormID, string paramMHoleID = null, string paramMachineID = null)
        {
            this.strFactoryID = paramFactoryID;
            this.strAreaID = paramAreaID;
            this.strPlatFormID = paramPlatFormID;
        ...
        /// <summary>Factory ID</summary>
        public List<string> FactoryID { get { return this.strFactoryID; } }

        /// <summary>Area ID</summary>
        public List<string> AreaID { get { return this.strAreaID; } }
