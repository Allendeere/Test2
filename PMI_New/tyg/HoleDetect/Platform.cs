...
namespace TYG.HoleDetect
{
    ...
    public class Platform : IDisposable
    {
        ...
        private List<Area> parent_new = new List<Area>();//將parent改成列表
        ...
        /// Hole Changed Event
        /// </summary>
        internal event HoleChangedEventHandler_new HoleChanged;

        /// <summary>
        /// Hole Changed Event
        /// </summary>
        internal event HoleChangedEventHandler_new HoleChanged_new;//取代HoleChanged事件
        ...
        internal Platform(Area parent, string paramID, string paramName, string paramIPAddress, int paramPort)
        {
            ...
            this.parent_new.Add(parent);//添加Area至Area列表
        ...
        public List<Area> Parent_new
        {
            get { return this.parent_new; }
        }
        ...
        internal void SetHoleDetection(ref string[] paramHoleDetection)
        {
            ...
            if (isChanged)
            {
                ...
                this.Parent_new.ForEach(x => areasID.Add(x.ID));
                List<string> factorysID = new List<string>();
                this.Parent_new.ForEach(x => factorysID.Add(x.Parent.ID));
                HoleChangedArgument_new e_new = new HoleChangedArgument_new(factorysID, areasID, this.ID);//將事件內部的string都改為list<string>
                e_new.HoleDetection = this.GetHoleDetection();
                this.refreshTime = DateTime.Now;
                this.OnHoleChanged_new(e_new);
            }
        }
        ...
        protected void OnHoleChanged(HoleChangedArgument_new e)
        {
        ...
        /// </summary>
        /// <param name="e">Event Argument</param>
        protected void OnHoleChanged_new(HoleChangedArgument_new e)
        {
            if (this.HoleChanged_new != null)
                this.HoleChanged_new(this, e);
        }
        #endregion
